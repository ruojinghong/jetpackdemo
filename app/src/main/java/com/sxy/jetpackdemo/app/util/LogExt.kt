package com.sxy.jetpackdemo.app.util
 ...
 * @author: sxy
 * @date: 2020/12/17
 * @description: 是否需要开启打印日志，默认打开，1.1.7-1.1.8版本是默认关闭的(1.0.0-1.1.6没有这个字段，框架在远程依赖下，直接不打印log)，
...
private fun log(level: LEVEL, tag: String, message: String) {
    if (!me.hgj.jetpackmvvm.ext.util.jetpackMvvmLog) return
    when (level) {
