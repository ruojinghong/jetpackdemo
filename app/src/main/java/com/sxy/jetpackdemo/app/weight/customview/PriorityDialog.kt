package com.sxy.jetpackdemo.app.weight.customview
...
import com.sxy.jetpackdemo.app.weight.recyclerview.GridDividerItemDecoration
...
//                addItemDecoration(GridDividerItemDecoration(it, 0, ConvertUtils.dp2px(24f), false))
    ...
    public fun setPriorityInterface(priorityInterface:PriorityInterface){
